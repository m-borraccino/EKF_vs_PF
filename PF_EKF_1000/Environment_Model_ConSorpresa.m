...
s=patch([yA yB yC yD],[xA xB xC xD], [0 0 0 0],'FaceColor','c','FaceAlpha',0.4);
s.EdgeColor = 'none';
...
% Plot del campo da calcio 
hold on; 
img1= imread('https://image.freepik.com/vettori-gratuito/campo-da-calcio-con-shock-per-giocare-a-calcio_68708-644.jpg');
...
pipAB=[xB+pcab1(1),yB+pcab1(2),-0.485];
...
pipBC=[hpc*sin(gammaBC),hpc*cos(gammaBC),-0.485];
...
pipCD=[hpcd*sin(gammaCD),hpcd*cos(gammaCD),-0.485];
...
pipDA=[xA+pcda1(1),yA+pcda1(2),-0.485];
